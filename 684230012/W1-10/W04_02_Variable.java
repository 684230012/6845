public class W04_02_Variable {
    public static void main(String[] args) {
        ...
        // สามารถรวมตัวแปรที่ประกาศไว้แล้วให้อยู่บรรทัดเดียวกันได้
        // ประกาศตัวแปร a และ b เป็นชนิดข้อมูล byte
        byte aa, bb; // ประกาศตัวแปร a และ b เป็นชนิดข้อมูล byte
        byte aaa = 0, bbb = 0; // ประกาศตัวแปร a และ b เป็นชนิดข้อมูล byte และกำหนดค่าเริ่มต้นเป็น 0 
        

        // ประกาศตัวแปรและชนิดข้อมูล พร้อมกับการกำหนดค่า
        short c = 30 ; // กำหนดค่า 30 ให้กับตัวแปร c

        int ch = '\u0044'; // กำหนดค่า 68 (ASCI ของ 'D') ให้กับตัวแปร ch
        System.out.println(ch);


        String ch1 = "\u0044"; // กำหนดค่า 68 (ASCI ของ 'D') ให้กับตัวแปร ch1
        System.out.println(ch1);

        String ch2 = "\u0044"; // กำหนดค่า 68 (ASCI ของ 'D') ให้กับตัวแปร ch2
